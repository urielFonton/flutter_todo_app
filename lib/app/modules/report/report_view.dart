          ...
          return ListView(
            children: [
              Padding(
                ...
                child: Text('Global Report', style: TextStyle(fontSize: 22.0.sp, fontWeight: FontWeight.bold),),
              ),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 4.0.wp),
                child: Text(DateFormat.yMMMMd().format(DateTime.now()), style: TextStyle(fontSize: 14.0.sp, color: Colors.grey),),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildStatus(Colors.orange, completedTasks, 'Completed Tasks'),
                    _buildStatus(Colors.green, createdTasks, 'Created Tasks'),
                  ],
                ),
              ),
              SizedBox(
                  ...
                  child: CircularStepProgressIndicator(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('Efficiency', style: TextStyle(
                          color: Colors.grey,
                          fontWeight: FontWeight.bold,
                        ),)
                      ],
